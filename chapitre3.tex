...
\section{Critères de discrimination}
...
\section{Modèle de génération de mouvement}
	...
	\subsubsection{Longeur et aire de l'enveloppe convexe}
	...
	\begin{figure}[htb]
		...
		\begin{subfigure}[t]{0.49\textwidth}
			...
			\caption[Enveloppe convexe, $A = 45$, $F=4$]{Enveloppe convexe, $A = 45$, $F=4$, $AF=180$. L'aire de l'enveloppe est d'environ 48~cm².}
		...
		\begin{subfigure}[t]{0.49\textwidth}
			...
			\caption[Enveloppe convexe, $A = 90$, $F=8$]{Enveloppe convexe, $A = 90$, $F=8$, $AF=720$. L'aire de l'enveloppe est d'environ 16,4~cm².}
		...
		\begin{subfigure}[t]{0.49\textwidth}
			...
			\caption[Enveloppe convexe, $A = 180$, $F=60$]{Enveloppe convexe, $A = 180$, $F=60$, $AF=10~800$. L'aire de l'enveloppe est d'environ 3,25~cm².}
			\label{fig:areaTraj_219_180_60}
		\end{subfigure}
		\caption[Enveloppes convexes]{Enveloppes convexes de quatre trajectoires de pseudo-entropies croissantes. À mesure que la pseudo-entropie croît, elles sont de plus en plus \og repliées \fg{} et l'aire de l'enveloppe convexe décroît.}
		\label{fig:trajAreas}
	\end{figure}
