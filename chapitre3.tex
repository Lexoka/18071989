...
\section{Introduction}
	...
	Ce choix est quelque peu arbitraire et subjectif, mais nécessaire, et nous semble d'autant plus justifié que c'est justement l'impression subjective des utilisateurs face à un certain type de mouvement qui nous intéresse, car nous faisons l'hypothèse (sur laquelle nous reviendrons plus loin) que cette impression subjective e performances de sélection.
	...
	\FloatBarrier \subsubsection{Objets susceptibles d'accélérer vivement}
