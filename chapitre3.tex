...
\end{table}
	...
	\begin{figure}[!htb]
		\begin{subfigure}[t]{\subImgWclicks}
			\centering
			\includegraphics[width=\textwidth]{figures/ch3/pacmann_filteredSpeed}
			\caption{Vitesses.}
			\label{fig:pacmann_filteredSpeed}
		\end{subfigure}
		~
		\begin{subfigure}[t]{\subImgWclicks}
			\centering
			\includegraphics[width=\textwidth]{figures/ch3/pacmann_frequency}
			\caption{Fréquences.}
			\label{fig:pacmann_frequency}
		\end{subfigure}
		~
		\begin{subfigure}[t]{\subImgWclicks}
			\centering
			\includegraphics[width=\textwidth]{figures/ch3/pacmann_angle}
			\caption{Angles.}
			\label{fig:pacmann_angle}
		\end{subfigure}
