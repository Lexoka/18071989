...
\section{Taxinomie des environnements de sélection}
    ...
    Afin, nous dirons que les objets dont les changements de direction sont instantanés sont de cinématique discrète, tandis que les autres sont de cinématique continue. Par  souci de concision, nous appellerons les premiés ciné-discrets et les second ciné-continus.
...
\section{Modèle de génération de mouvement}
	...
	Plus $F$ est élevée, plus la direction change souvent. Plus $A$ est élevée, plus ces changements peuvent être importants. Par 
