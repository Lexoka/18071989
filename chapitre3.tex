...
\section{Taxinomie des environnements de sélection}
    ...
    % --- cette décision est éventuellement contrainte par les performances du système dans le cas d'une simulation interactive. Nous verrons plus loin qu'il s'agit d'un thème récurrent.
