...
\section{Taxinomie des environnements de sélection}
    ...
    \paragraph{Cinématique discrète ou continue}
	...
	\subsubsection{Amplitude des changements de direction}
	...
	\paragraph{Nature discrète ou continue}
...
\section{Modèle de génération de mouvement}
	...
	\begin{itemize}
		\item Plus $F$ est élevée, plus la direction change souvent,
		\item Plus $A$ est élevée, plus ces changements peuvent être importants,
	...
	\paragraph{Examen détaillé des trajectoires.}
	...
	\subparagraph{Effet des fréquences.}
	Un examen de n'importe quel bloc de six trajectoires pour une valeur de $A$ donnée montrera que plus $F$ est grande, plus les trajectoires sont irrégulières.
