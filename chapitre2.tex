...
\section{Curseurs zonaux}
	Les curseurs zonaux génériques tels que le \emph{Bubble Cursor} peuvent être utilisés pour des cibles mobiles, mais sont peu adaptés à ce type de tâche. Cette technique souffre par exemple d'un problème d'instabilité quand les cibles bougent.
	
	\subsection{\emph{DynaSpot}}
	...
	\subsubsection{Ambiguïté et ralentissements}
