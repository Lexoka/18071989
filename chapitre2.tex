...
\subsection{Curseurs zonaux}
	...
	\begin{figure}[!htbp]
		\begin{subfigure}[t]{0.49\textwidth}
			...
			\caption{\emph{Bubble Cursor} (a,c,d) par opposition à un curseur zonal (b). (b) : le curseur zonal ne permet pas aisément de choisir entre les deux cibles qui se trouvent dans la zone de sélection. Mais le \emph{Bubble Cursor} s'adapte (c et d). (d) : la cible n'est pas \emph{entièrement} recouverte par le disque du curseur, mais le curseur est localement étendu pour l'envelopper.}
			\label{fig:bubble}
		\end{subfigure}
		~
		\begin{subfigure}[t]{0.49\textwidth}
...
\section{Taxinomie des techniques de sélection}
	...
	Nous proposons un schéma récapitulatif de la taxinomie exposée ici sur la figure~\ref{fig:selTaxi}.
