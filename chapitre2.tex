...
\section{\emph{Raycasting} avec désambiguïsation}
	...
	\newcommand{\rayWidth}{0.65\textwidth}
	\begin{figure}[!htb]
		\centering
	...
	\begin{figure}[!htb]
		...
		\begin{subfigure}[t]{0.49\textwidth}
			...
			\caption{Pour les cibles dont les identifiants sont faibles (plutôt situées vers la gauche) le \emph{Smart Ray} fournit de bons résultats, mais ils sont très mauvais pour les cibles dont les identifiants sont élevés (plutôt à droite). Or, tous les sujets de l'évaluation étaient droitiers, donc le rayon venait également de la droite. De fait, il rencontrait beaucoup d'obstacles dans ce cas.}
