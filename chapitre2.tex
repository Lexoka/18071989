...
\section{Techniques pour la sélection de cibles mobiles}
	...
	\begin{SCfigure}[50][!htbp]
		...
		\caption[\emph{AttachedShock}, performance]{Évaluation d'\emph{AttachedShock}. Le taux d'erreurs est en abscisse, le temps de sélection en ordonnée. \emph{AttachedShock} ne fait pas bien mieux qu'un curseur zonal en temps de sélection, mais le taux d'erreurs est très bas. Résultats tirés de~\cite{you2012attachedshock}.}
		\label{fig:asRes}
	\end{SCfigure}
	...
	\begin{figure}[!htbp]
		\centering
		\includegraphics[width=0.8\textwidth]{figures/ch2/asDensity}
