...
\section{Introduction}
	...
	Sauf figure~\ref{fig:holdID}.
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{figures/ch2/holdID}
		\caption[Indice de difficulté en fonction de la nature du mouvement]{Bla. Crédit : \cite{hajri2011moving}.}
		\label{fig:holdID}
	\end{figure}
...
\section{\emph{Hold}}
	...
	Tech choice figure~\ref{fig:holdTech}.
	
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{figures/ch2/holdTech}
		\caption[\emph{Hold} --- choix de la technique]{Blabla. Crédit : \cite{hajri2011moving}.}
		\label{fig:holdTech}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption[\emph{Hold} --- distribution \emph{Hold/Chase} en mode \emph{Hybrid}]{Blabla. Crédit : \cite{hajri2011moving}.}
		\label{fig:holdRatio}
	\end{figure}
