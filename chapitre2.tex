...
\section{\emph{Raycasting} avec désambiguïsation}
	...
	\begin{figure}[!htb]
		...
		\begin{subfigure}[t]{0.49\textwidth}
			...
			\caption{Pour les cibles dont les identifiants sont faibles (plutôt situées vers la gauche) le \emph{Smart Ray} fournit de bons résultats, mais ils sont mauvais pour les cibles d'identifiant sont élevé (à droite). Tous les sujets de l'évaluation étaient droitiers, donc le rayon venait également de la droite, et rencontrait beaucoup d'obstacles.}
