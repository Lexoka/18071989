...
\cleardoublepage
	...
	\begin{description}
		...
		\item[CPK.] Une technique de visualisation très courante est appelée CPK, en référence aux modèles physiques créés par les chimistes Robert \textbf{C}orey, Linus \textbf{P}auling, et Walter \textbf{K}oltun.
		\item[VdW.] Blabla
