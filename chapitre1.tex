...
\cleardoublepage
    ...
    \begin{figure}[ht]
		...
		\caption{Illustration d'une protéine (1KX2, un mono-hème ferrocytochrome) produite avec le logiciel UnityMol~\cite{doutreligne2014unitymol}.}
		\label{fig:1KX2}
	\end{figure}
    ...
    Densité, occultaton, vitesse, prévisibilité, etc.
