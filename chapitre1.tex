...
\cleardoublepage
	...
	\paragraph{Simulations interactives en immersion.}
	Le système \emph{Protein Interactive Theater} illustré par la figure~\ref{fig:steeredPIT} se veut également \emph{immersif}.
	
	\paragraph{Retour haptique.}
