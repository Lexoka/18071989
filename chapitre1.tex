...
\cleardoublepage
	...
	\begin{table}[ht]
		...
		Héros				&	Temps de demi-tour (180°)	&	Vitesse (unités abritraires)	\newrow
		Lifestealer		&	0.094 s
		Batrider, Bristleback,
		Faceless Void,
		Lifestealer, Phoenix,
		Shadow Fiend			&	0.094 s				\newrow
		Earthshaker			&	0.105 s				\newrow
		Magnus, Storm Spirit		&	0.118 s				\newrow
		Drow Ranger, Io,
		Pudge, Rubick,
		Sniper, Templar Assassin	&	0.135 s				\newrow
		Meepo					&	0.145 s				\\
		\end{tabular}
