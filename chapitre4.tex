...
\section{Enveloppes convexes et performances de sélection}
	...
	Nous proposons une telle fonction définie par :
	$g(x) = 2.65\frac{x-b}{\sigma^{2}}e^{-\frac{(x-b)^{2}}{2\sigma^{2}} } $ (où $\sigma$ et $b$ sont des paramètres réels, qui valent respectivement 3 et 1 ici), et dont une représentation graphique est fournie sur la figure~\ref{fig:timeVareaFit}.
