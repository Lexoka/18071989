...
\section{Aires des enveloppes convexes et temps de sélection}
	...
	\begin{align}
		...
		f(A\sqrt{F}) &= 10 \left( 1 + \frac{A^{2}F}{150^{2}} \right)^{-\frac{1}{2}}
	\end{align}
...
\section{Enveloppes convexes et performances de sélection}
	...
	\begin{figure}[!htbp]
		...
		\caption[Temps de sélection/V en fonction de $A\sqrt{F}$ et modèle]{Temps de sélection normalisés divisés par la vitesse, en fonction de $A\sqrt{F}$, pour les cibles rapides et de vitesse intermédiaire ; proposition de modèle. Le coefficient de corrélation est supérieur à 0,854.}
