...
\section{Résultats : performances de sélection}
	...
	\subsection{Vitesse}
	Sans surprise, les temps de sélection et les taux d'erreurs croissent avec la vitesse des cibles, comme l'illustre la figure~\ref{fig:spEffectPerf}. Ainsi, la moyenne des MTSN de toutes les conditions lentes (0,73~cm/s) est de
...
%	\newcommand{\newrow}{\bigstrut[t] \\ \hline}
	\begin{table}
		...
		\begin{tabular}{c c | c c c}
			...
			Basse			& 16,74	&		&			&		\bigstrut[t] \\
			Moyenne			& 25,02	&		&			&		\\
			Haute			& 36,58	&		&			&		\\
		\end{tabular}
		\caption[Performances selon la vitesse]{Performances de sélection (MTSN moyennes) selon la vitesse, et différences de pourcentages.}
		\label{tab:spPerf}
	\end{table}
	
 average ANST at the highest speed (37\%{}) is
