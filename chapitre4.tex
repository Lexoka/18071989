...
\section{Aires des enveloppes convexes et temps de sélection}
	...
	C'est pourquoi, pour modéliser ces données, nous avons opté pour le modèle de l'équation~\ref{eq:doublePower}, avec les valeurs numériques présentées dans l'équation~\ref{eq:doublePowerNum}.
	...
	Ce modèle nous permet d'exprimer l'aire directement en fonction de nos paramètres, selon l'équation~\ref{eq:areaModel}.
