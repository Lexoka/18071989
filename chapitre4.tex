...
\section{Aires des enveloppes convexes et temps de sélection}
	...
	\begin{figure}[!htbp]
		...
		\caption[Coefficients $\delta$ en fonction de F et A]{Carte thermique de l'aire de l'enveloppe convexe en fonction de F et A, sur une échelle log-log. Les angles se lisent en abscisse, les fréquences en ordonnée, et la valeur de $\delta$ est indiquée par la couleur, selon l'échelle de droite.}
