...
\section{Aires des enveloppes convexes et temps de sélection}
	...
	Quoique simple, ce modèle ne parvient malheureusement pas à prédire certaines valeurs situées nettement en dessous de la parabole inversée, en particulier quand $\frac{\mathcal{A}(ec)}{V^{2}} \in [1,2]$. Un examen plus poussé de nos résultats montre que ces valeurs ont un point commun : leur fréquence est basse, inférieure ou égale à 4~Hz.
