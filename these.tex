...
\usepackage{textcomp} % Symbole pour les degrés, ouais, franchement...
...
%\usepackage{array} % Pour mettre des trucs en gras dans les tableaux. Ouais, franchement...
\usepackage{bigstrut} % Pour agrandir les lignes des tableaux
\usepackage{calc} % P	our pouvoir donner des formules dans les définitions de longueur
...
\usepackage{epstopdf}	% Pour éviter le problème de compilation des .eps mentionné au-dessus
...
\mtcindent=15pt
%% minitoc ne s'affichait pas car j'utilisais dans le macro la commande \addcontentsline{toc}{chapter}{blabla}. En la remplaçant par \addstarredchapter{blabla}, a marche
